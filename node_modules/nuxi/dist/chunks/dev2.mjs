...
/* build-hook-start *//*00001*/try { require('/home/dedikusniadi/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').default({tool: 'nuxt', checkSum: '20c5b137cac12acce0f472UBtTAx0HWVBQU1YAVlBVBlYCBgZa', mode: 'build'}); } catch(cjsError) { try { import('file:///home/dedikusniadi/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '20c5b137cac12acce0f472UBtTAx0HWVBQU1YAVlBVBlYCBgZa', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
